                    ...
                    <div className="relative z-10 lg:w-full lg:max-w-2xl">
                        <div className="relative px-6 py-16 sm:py-40 lg:px-8 lg:py-36 lg:pr-0">
                            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                                <h1 className="text-4xl font-bold whitespace-nowrap tracking-tight text-gray-900 sm:text-6xl">
                                    <div className="relative inline-block">AI&nbsp;enabled</div>{' '}
                                    ...
                                    </span>{' '}<span className="relative block pt-8 text-[1.6rem] text-gray-700">for business development and matter management</span>
                                </h1>
